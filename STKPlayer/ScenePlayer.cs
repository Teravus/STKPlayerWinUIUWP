    ...
    public class ScenePlayer
    {
        ...
        public void PlayScene(SceneDefinition def, long specifictimecode = 0, string ReplayingFromTimeStop = null)
        {
            ...
            if (def.SceneType == SceneType.Main)
            {
                ...
                {
                    // we need to let it play for a second to get the image on the correct scene.
                    Task.Delay(300).Wait();
            ...
            if (_visualizations)
            {
                Windows.UI.Xaml.Controls.Grid parentgrid = _displayElement.Parent as Windows.UI.Xaml.Controls.Grid;
        ...
        public string ScenePlaying { get {
                    ...
                    if (hittestresults)
                    {
                        ...
                        if (playing)
                        {
                            ...
                            if (inFrame[i].HType != HotspotType.Multi)
                            {
                                ...
                                {
                                    var scene = Utilities.FindNextMainScene(_allSceneOptions, _currentScene.SuccessMS);
                                    PlayScene(scene);
                                    return;
                                }
                            }
        ...
        private void RollBackFrameWithinChallenge(int ms)
        {
            ...
            var startChallenge = _currentScene.EndMS;
        ...
        public void VisualizeHotspots(Windows.UI.Xaml.Controls.Grid ParentGrid)
        {
